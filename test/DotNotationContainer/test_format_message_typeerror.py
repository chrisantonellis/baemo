...
class Test(unittest.TestCase):
  ...
  def test_format_message_typeerror(self):
    """ format_message_typeerror returns a message formatted for use in a 
    TypeError
    """
    ...
    self.assertEqual(a.format_message_typeerror(type_, needle, key), message)
